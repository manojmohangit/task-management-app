...
function AddTaskForm() {
    ...
    function handleSubmit(e: SubmitEvent<HTMLFormElement>) {
        ...
        navigate('/', { state: { toastMessage: "Task added successfully!" }, viewTransition: true });
    }

    return (
        <div className="container">
            <header>
                <NavLink to="/" viewTransition><i className="mr-2 bi bi-arrow-left pointer text-white"></i></NavLink> Add Task
            </header>
            <div className="content" style={{ viewTransitionName: 'content' }}>
